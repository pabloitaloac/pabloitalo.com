...
function Home2(props) {
  ...
  return (
    <Container
      ...
      id='about'
      style={{ marginTop: -200, color: !nightMode && 'black' }}
    >
      <Container>
        <Row>
          <Col
          ...
          >
            ...
            >
              {props.datatoShow.home4}{' '}
              <span className='purple'>{props.datatoShow.home5}</span>{' '}
              {props.datatoShow.home6}
            </h1>
            <p
        ...
        <Row>
          <Col md={12} className='home-about-social'>
            <h1 style={{ color: !nightMode && 'black' }}>
              {props.datatoShow.home13}
            </h1>
            <p style={{ color: !nightMode && 'black' }}>
              {props.datatoShow.home14}{' '}
              <span className='purple'>{props.datatoShow.home15} </span>
              {props.datatoShow.home16}
            </p>
