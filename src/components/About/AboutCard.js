      ...
      <Card.Body>
        ...
        >
          <p style={{ textAlign: 'justify' }}>
            {props.datatoShow.about3}{' '}
            <span className='purple'>Pablo Ítalo</span>
            {props.datatoShow.about5}{' '}
            <span className='purple'>{props.datatoShow.about6}</span>.
            <br />
            {props.datatoShow.about7}{' '}
            <span className='purple'>{props.datatoShow.about8}</span>
            <br />
            {props.datatoShow.about9}{' '}
            <span className='purple'>{props.datatoShow.about10}</span>
            <br />
